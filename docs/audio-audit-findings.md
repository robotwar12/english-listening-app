...
- 1차 일치 675개, 2차 모델에서 일치 38개.
- 다음 번호 단어로 인식되는 후보 4개, 기타 재확인 33개.
- 검사 스크립트는 음원을 수정하지 않는다. 301~319번 음원은 별도 교정 후 재검사했다.
- 음성 인식 판정이며 실제 청취 확정이나 한국어 뜻 전체의 사전 검증은 아니다.

## 파일명이 한 칸 밀린 것으로 의심되는 구간

아래는 현재 캐시에서 다음 번호 단어로 인식된 파일이다. 301~319번은 교정 후 재검사했다. 626~629번은 아직 교정하지 않았다.

| 파일명 단어 | 화면 뜻 | 1차 인식 | 2차 인식 | 2차 단어에 해당하는 뜻 |
|---|---|---|---|---|
| 626_stick.mp3 | 붙이다 | Joy. | Joy | 기쁨 |
| 627_joy.mp3 | 기쁨 | League | League | (스포츠 경기의) 리그 |
| 628_league.mp3 | (스포츠 경기의) 리그 | germ | germ | 세균, 병균 |
| 629_germ.mp3 | 세균, 병균 | Object | Object | 물건, 사물; 반대하다 |
